...
// Person schema — Roberto Ruiz Mirabal (founder) — primary EEAT signal
const personSchema = {
  '@context': 'https://schema.org',
  '@type': 'Person',
  '@id': `${BASE_URL}/#roberto-ruiz-mirabal`,
  name: 'Roberto Ruiz Mirabal',
  jobTitle: 'Founder & Lead Exterior Cleaning Specialist',
  description:
    'Roberto Ruiz Mirabal is the founder and hands-on lead specialist at R.R.M External Cleaning Specialist. With 10+ years of experience in professional exterior cleaning across North West England, Roberto personally carries out every job — no subcontractors.',
  url: `${BASE_URL}/about`,
  image: `${BASE_URL}/images/roberto-ruiz-mirabal-rrm-owner.jpg`,
  sameAs: ['https://www.facebook.com/share/19ug8KMzT4/'],
  worksFor: { '@id': `${BASE_URL}/#localbusiness` },
  knowsAbout: [
    'Exterior Cleaning', 'Pressure Washing', 'Soft Washing', 'Roof Cleaning',
    'Driveway Cleaning', 'Render Cleaning', 'Gutter Cleaning', 'K-Rend Cleaning',
    'Biocide Treatment', 'Exterior Property Maintenance',
  ],
  hasOccupation: {
    '@type': 'Occupation',
    name: 'Exterior Cleaning Specialist',
    occupationLocation: {
      '@type': 'City',
      name: 'Newton-le-Willows',
    },
    estimatedSalary: null,
    description: 'Professional exterior cleaning specialist with expertise in pressure washing, soft washing, roof cleaning, driveway cleaning, render cleaning, and gutter clearing across North West England.',
  },
};
...
const orgSchema = {
  ...
  description:
    'R.R.M External Cleaning Specialist is a professional exterior cleaning company established in 2016 by Roberto Ruiz Mirabal, based in Newton-le-Willows, Merseyside. We provide 40 exterior cleaning services across 21 locations in the North West including Warrington, St Helens, Manchester, Liverpool, Widnes, and Leigh. Fully insured, no subcontracting, available 24/7.',
  ...
  sameAs: [
    'https://www.facebook.com/share/19ug8KMzT4/',
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([personSchema, orgSchema, breadcrumbSchema]) }}
      />
      <AboutPageContent />
    </>
  );
